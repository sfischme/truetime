#define S_FUNCTION_NAME right_init
...
double right_code(int segment, void* t_d)
{
  data* d = (data*) t_d;
...
void init()
{
  ...
  ttCreatePeriodicTask("right", offset, period, prio, right_code, da[bot_nbr -1]);
  ttSetPriority(prio, "right");
