...
if (msg.coll~=1)
  ...
  %Noden är under bollen. Passa, skjuta eller dribbla?
  if(yPos(node)<yBall)
    %Passa
    %Funktionen returnerar närmaste nod ovanför bollen. Returnerar -1 om det
    %inte finns någon nod ovanför
...
%func=2 Noden ligger över bollen.
